<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/laundry/dashboard') }}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('laundry/outlet') }}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('laundry/paket') }}">
