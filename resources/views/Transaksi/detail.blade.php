        ...
        <div class="col-4">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <input type="number" id="" name="" class="form-control mt-2" placeholder="{{ $detail [0]['kode_invoice'] }}" readonly><br>
                    <label for="exampleFormControlInput1" class="form-label">Nama Pelanggan</label>
                    <input type="number" id="" name="" class="form-control mt-2" placeholder="{{ $detail [0]['nama'] }}" readonly><br>
                    ...
                    @if($detail[0]['pembayaran'] == 'sudahdibayar')
                        <input type="number" id="lunas" name="lunas" class="form-control mt-2" placeholder="Lunas" readonly><br>
                    @else
                        <input type="number" id="belum_lunas" name="belum_lunas" class="form-control mt-2" placeholder="Belum Lunas" readonly><br>
                    @endif
...
@section('script')
    <script>
        ...
        var url = "{{ url('laundry/cetakstrukbaru/'.$detail->idtransaksi) }}";
